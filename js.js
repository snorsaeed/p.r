...
const products = [
  ...
  { id: 23, name: 'Dolce & Gabbana - K (M) EDP 100ml', image: 'https://m.media-amazon.com/images/I/51aLVEkkSBL.jpg', price: 105, summary: 'K by Dolce & Gabbana is a masculine fragrance that combines citrus freshness with spicy and woody undertones, creating a powerful and charismatic scent.', gender: 'Male' , availability: 'yes'},
  ...
  { id: 27, name: 'Dolce & Gabbana - Q (W) EDP 100ml', image: 'https://hermitage.am/storage/10552/1690290106.jpg', price: 145, summary: 'Q by Dolce & Gabbana is a regal and captivating fragrance with notes of Sicilian lemon, cherry, and cedarwood, evoking a sense of elegance and strength.', gender: 'Female' , availability: 'yes'},
  { id: 28, name: 'Dolce & Gabbana - The One (M) EDP 100ml', image: 'https://www.beirutdutyfree.com/media/products/large/6992_1629372321_theoneformeneaudeparfum100150ml.png', price: 105, summary: 'The One for men by Dolce & Gabbana is a warm and spicy fragrance with notes of grapefruit, ginger, and tobacco, creating a sophisticated and timeless scent.', gender: 'Male' , availability: 'yes'},
  { id: 29, name: 'Versace - Crystal Noir (W) EDP 90ml', image: 'https://skinsociety.me/cdn/shop/files/versace-crystal-noir-eau-de-parfum-skin-society-shop-address-country-2.jpg?v=1686485842', price: 111, summary: 'An exotic and sensual scent with notes of gardenia, amber, and coconut.', gender: 'Female' , availability: 'yes'},
  { id: 30, name: 'Versace - Dylan Blue (M) EDT 100ml', image: 'https://cdn2.easycosmetic.be/images/Produkte/D2/versace-pour-homme-dylan-blue-edt-vapo-30ml.png', price: 95, summary: 'A powerful and fresh fragrance with notes of bergamot, grapefruit, and black pepper.', gender: 'Male' , availability: 'yes'},
  { id: 31, name: 'Versace - Eros (M) EDP 100ml', image: 'https://m.media-amazon.com/images/I/51OeIdhUpnL._AC_.jpg', price: 95, summary: 'A masculine fragrance with notes of mint, vanilla, and tonka bean.', gender: 'Male' , availability: 'yes'},
  { id: 32, name: 'Versace - Eros (M) Parfum 100ml', image: 'https://tse4.mm.bing.net/th?id=OIP.Z1I4wOcQgyFa6SNWz4GltAHaHa&w=474&h=474&c=7', price: 124, summary: 'A rich and sensual scent with notes of mint, vanilla, and cedarwood.', gender: 'Male' , availability: 'yes'},
  { id: 33, name: 'Versace - Eros Flame (M) EDP 100ml', image: 'https://www.fridaycharm.com/cdn/shop/products/Versace-Eros-Flame-EDP-M-100ml-2.jpg?v=1674135638', price: 88, summary: 'A spicy and woody scent with notes of mandarin, black pepper, and vanilla.', gender: 'Male' , availability: 'yes'},
  { id: 34, name: 'Versace - Oud Oriental (W) EDP 100ml', image: 'https://faces.pearlbrandsonline.com/wp-content/uploads/sites/2/2023/09/8011003818167.jpg', price: 110, summary: 'A warm and intense fragrance with notes of saffron, rose, and oud wood.', gender: 'Female' , availability: 'yes'},
  { id: 35, name: 'Versace - Pour Homme (M) EDT 100ml', image: 'https://perfumegallery.ae/cdn/shop/files/Untitleddesign_7_f8ed4902-5bfe-42d5-a034-3b93446ce10e.png?v=1685966328', price: 76, summary: 'A classic masculine fragrance with notes of lemon, cedar, and tonka bean.', gender: 'Male' , availability: 'yes'},
  ...
  { id: 37, name: 'Yves Saint Laurent - Libre (W) EDP 90ml', image: 'https://www.bluesalon.com/cdn/shop/files/YSL121PER00167.jpg?v=1698838946', price: 137, summary: 'A modern and empowering fragrance blending lavender, orange blossom, and musk, symbolizing freedom and femininity.', gender: 'Female', availability: 'yes' },
  ...
  { id: 39, name: 'Yves Saint Laurent - Myslf (M) EDP 100ml', image: 'https://m.media-amazon.com/images/I/412TXqfY5jL._SL1000_.jpg', price: 141, summary: 'A warm and woody fragrance with notes of orange blossom, bourbon vanilla, and sandalwood, perfect for the modern, self-assured man.', gender: 'Male' , availability: 'yes'},
  { id: 40, name: 'Yves Saint Laurent - Y (M) EDP 100ml', image: 'https://www.yslbeauty.sa/dw/image/v2/BDCL_PRD/on/demandware.static/-/Sites-ysl-master-catalog/default/dwb551142f/Fragrance/Y_EDP/3614272050341_60ml_y-eau-de-parfum_Alt1.png?sw=500&sh=600', price: 133, summary: 'A fresh and spicy fragrance with bergamot, ginger, and woody notes, embodying a youthful and energetic spirit.', gender: 'Male', availability: 'yes'},
  { id: 41, name: 'Yves Saint Laurent - Y Le Parfum (M) EDP 100ml', image: 'https://www.bigbrands.ae/wp-content/uploads/2022/11/YVES-SAINT-LAURENT-Y-LE-PARFUM-M-EDP-100-ML-VAPO-500-%C3%97-500-px-2.png', price: 150, summary: 'A richer, more intense version of Y, with notes of tonka bean, sage, and cedarwood, offering a refined and luxurious experience.', gender: 'Male', availability: 'yes' },
  { id: 42, name: 'Roberto Cavalli - Florence (W) EDP 75ml', image: 'https://cdn.ae1stcry.com/brainbees/images/products/438x531/83fffae0e1c84a.webp', price: 87, summary: 'A floral and elegant fragrance with notes of gardenia, jasmine, and sandalwood, perfect for a sophisticated and timeless appeal.', gender: 'Female' , availability: 'yes'},
  { id: 43, name: 'Roberto Cavalli - Gold Collection Royal Soul (U) Parfum 100ml', image: 'https://www.myperfumeshop.com.au/cdn/shop/files/roberto-cavalli-royal-soul-edp-perfume-cologne-800498.png?v=1719364305&width=1000', price: 145, summary: 'A luxurious and unisex fragrance with notes of bergamot, patchouli, and amber, exuding opulence and depth.', gender: 'Unisex' , availability: 'yes'},
  { id: 44, name: 'Roberto Cavalli - Gold Collection Sublime Tonka (U) EDP 100ml', image: 'https://perfumeunlimited.com/media/catalog/product/cache/426571a213995d0f26cf05297c4bc27d/r/o/roberto_cavalli_gold_collection_sublime_tonka_unisex_eau_de_parfum_100ml1.jpg', price: 139, summary: 'A warm and sensual unisex fragrance with notes of tonka bean, vanilla, and almond, offering a rich and comforting aroma.', gender: 'Unisex' , availability: 'yes'},
  { id: 45, name: 'Roberto Cavalli - Just Cavalli (M) EDT 75ml', image: 'https://media.theperfumeshop.com/medias/sys_master/prd-images/h2c/he3/8865136640030/zoom-front-1131390_420x420/roberto-cavalli-just-cavalli-eau-de-toilette-spray-420x420', price: 53, summary: 'A fresh and masculine fragrance with notes of cardamom, leather, and vetiver, perfect for a modern and confident man.', gender: 'Male', availability: 'yes' },
  ...
  { id: 47, name: 'Roberto Cavalli - Paradiso (W) EDP 100ml', image: 'https://fimgs.net/mdimg/perfume/375x500.28609.jpg', price: 83, summary: 'A vibrant and tropical fragrance with notes of coconut, vanilla, and tiare flower, evoking the essence of a sunny paradise.', gender: 'Female' , availability: 'yes'},
  ...
  { id: 49, name: 'Roberto Cavalli - Roberto Cavalli (W) EDP 75ml', image: 'https://orisdi.com/cdn/shop/products/roberto-cavalli-perfume.jpg?v=1559804978', price: 65, summary: 'A sensual and floral fragrance with notes of orange blossom, vanilla, and amber, embodying femininity and allure.', gender: 'Female', availability: 'yes' },
  { id: 50, name: 'Roberto Cavalli - Uomo (M) EDT 100ml', image: 'https://www.feelingsexy.com.au/images/products/allproducts/ROBERTOCAVALLI_UOMO_NEW100.jpg', price: 64, summary: 'A woody and spicy fragrance with notes of violet, leather, and vetiver, perfect for a refined and masculine man.', gender: 'Male' , availability: 'yes'},
...
function loadItems(filteredProducts = products) {
  ...
  // Filter products to include only available items
  const availableProducts = filteredProducts.filter(product => product.availability === 'yes');
  ...
  availableProducts.forEach(product => {
    ...
    img.onclick = () => {
      ...
      localStorage.setItem('sammary', product.summary+' '+product.id);
...
function filterProducts() {
  ...
  if (currentPage === 'man.html') {
    ...
    filteredProducts = products.filter(product => (product.gender === 'Male' || product.gender === 'Unisex') && product.availability === 'yes');
  } else if (currentPage === 'woman.html') {
    // Display Female and Unisex products
    filteredProducts = products.filter(product => (product.gender === 'Female' || product.gender === 'Unisex') && product.availability === 'yes');
  } else {
    // For home page or other pages, show all available products
    filteredProducts = products.filter(product => product.availability === 'yes');
  }
